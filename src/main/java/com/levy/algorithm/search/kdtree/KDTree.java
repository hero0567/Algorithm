...
public class KDTree {
     ...
     * @return
     */
    public double[] nearest(double[] input,double[][] data){
        double[] nearest=null;
    ...
    public void performance(int iteration,int datasize){
        int count = iteration;
    ...
    public static void main(String[] args) {
        ...
        kdTree.performance(100000,10000);
    }
